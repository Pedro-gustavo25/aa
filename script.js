...
const keyDownMapper = {
    ...
    "x" : () =>handleMouseDown(keys[24]),
    "d" : () =>handleMouseDown(keys[25]),
    "c" : () =>handleMouseDown(keys[26]),
    "f" : () =>handleMouseDown(keys[27]),
    "v" : () =>handleMouseDown(keys[28]),
    "b" : () =>handleMouseDown(keys[29]),
    "h" : () =>handleMouseDown(keys[30]),
    "n" : () =>handleMouseDown(keys[31]),
    "j" : () =>handleMouseDown(keys[32]),
    "m" : () =>handleMouseDown(keys[33]),
    "k" : () =>handleMouseDown(keys[34]),
...
const keyUpMapper = {
    ...
    "x" : () => handleMouseUp(keys[24]),
    "d" : () => handleMouseUp(keys[25]),
    "c" : () => handleMouseUp(keys[26]),
    "f" : () => handleMouseUp(keys[27]),
    "v" : () => handleMouseUp(keys[28]),
    "b" : () => handleMouseUp(keys[29]),
    "h" : () => handleMouseUp(keys[30]),
    "n" : () => handleMouseUp(keys[31]),
    "j" : () => handleMouseUp(keys[32]),
    "m" : () => handleMouseUp(keys[33]),
    "k" : () => handleMouseUp(keys[34]),
